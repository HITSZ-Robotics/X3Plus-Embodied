...
def main():
    ...
    depth_image = np.fromfile(base_path+'depth_at_click_595_40.png', dtype=np.uint16).reshape((height, width))

    # 假设颜色图像与深度图像的尺寸相同
    color_image = cv2.imread(base_path+'rgb_with_marker_at_click_595_40.jpg')
